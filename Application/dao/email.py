...
class EmailDAO:
    ...
    def getEmailFromUser(self, email_id,user_id):
        cursor = self.conn.cursor()
        query = "select user_id,email_id,date_created,subject,body from \"Email\" where email = %s and user_id = %s and is_deleted != 1;"
